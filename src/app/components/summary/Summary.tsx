...
const Summary: FunctionComponent<SummaryProps> = (props: SummaryProps) => (
    <div className="w-full h-full justify-center space-y-2">
        <Title>Resumen</Title>
        <div className="px-2 space-y-2">
            {props.summary &&
                <div className="text-lg bg-gray-900 px-2 pb-2 space-y-2 divide-y divide-y-blue-50 text-white flex flex-col border-2 border-secondary">
                    ...
                    <SummaryRow title="Piso" value={{ label: props.summary.tax.floor, className: "text-red-300" }} />
